...
@Configuration
public class SummerFileConfig implements WebMvcConfigurer {
    @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        if (os.toLowerCase().startsWith(windowsFlag)) {
            registry.addResourceHandler("/file/summer/**")
                    .addResourceLocations("file:D:\\static\\file\\summer\\");
            //linux 和mac
        } else {
            registry.addResourceHandler("/file/summer/**")
                    .addResourceLocations("file:\\var\\file\\summer\\");
        }
    }
}
